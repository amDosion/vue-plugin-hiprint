/**
 * uom.spec.js — pt / px / mm conversions.
 *
 * happy-dom 不实测 1in 物理尺寸, getDpi() fallback 96 (现代浏览器默认 DPI).
 */
import { describe, it, expect } from 'vitest'
import { pt, px, mm, _resetDpiCache } from '../uom.js'
...
describe('uom (96 DPI fallback)', () => {
  ...
  it('pt to mm (1pt ≈ 0.353mm)', () => {
    // pt 1 → px (1 * 96/72) = 1.333 → mm (1.333 / 96 * 25.4) ≈ 0.35
    expect(pt.toMm(72)).toBeCloseTo(25.4, 1) // 72pt = 1 inch = 25.4mm
  })
