...
/**
 * RectElement.vue — V3 rectangle etype (P17.2).
 *
 * Pure CSS shape — `border` on a full-size div.
 * Mirrors render.ts renderShapeElement for type === 'rect'.
 */
...
<template>
  ...
  >
    <div class="hiprint-printElement-rect-content" :style="shapeStyle" />
  </ElementWrapper>
</template>
